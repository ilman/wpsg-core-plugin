...
class WPBakeryShortCode_wpsg_carousels extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		$controls_move = ' <a class="vc_control column_move vc_column-move" href="#" title="' . esc_attr__( 'Drag row to reorder', 'js_composer' ) . '" data-vc-control="move"><i class="vc-composer-icon vc-c-icon-dragndrop"></i> '.$this->settings['name'].'</a>';
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		if ( '' === $content && ! empty( $this->settings['default_content_in_template'] ) ) {
			...
			if(!$content){
				$content = '[wpsg_carousel_item][/wpsg_carousel_item]cfgh';
			}
